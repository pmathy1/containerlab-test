...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_AVD-LEAF1_Ethernet2 | routed | - | 172.31.255.2/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_AVD-LEAF2_Ethernet2 | routed | - | 172.31.255.6/31 | default | 1500 | false | - | - |
| Ethernet3 | P2P_LINK_TO_AVD-LEAF3_Ethernet2 | routed | - | 172.31.255.10/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_AVD-LEAF4_Ethernet2 | routed | - | 172.31.255.14/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_AVD-LEAF1_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_AVD-LEAF2_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description P2P_LINK_TO_AVD-LEAF3_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description P2P_LINK_TO_AVD-LEAF4_Ethernet2
   no shutdown
   mtu 1500
   no switchport
