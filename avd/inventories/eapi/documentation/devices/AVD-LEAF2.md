...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 172.20.20.8/24 | 172.20.20.1 |
...
| --------- | --------------- | ------------ | --------- |
| AVD_LEAF12 | Vlan4094 | 10.255.252.0 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_AVD-LEAF1_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | server01_Ethernet2 | *trunk | *110-299 | *- | *- | 4 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_AVD-SPINE1_Ethernet2 | routed | - | 172.31.255.5/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_AVD-SPINE2_Ethernet2 | routed | - | 172.31.255.7/31 | default | 1500 | false | - | - |
...
!
interface Ethernet3
   description MLAG_PEER_AVD-LEAF1_Ethernet3
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_AVD-LEAF1_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
| Port-Channel4 | server01_PortChannel4 | switched | trunk | 110-299 | - | - | - | - | 4 | - |
...
interface Port-Channel3
   description MLAG_PEER_AVD-LEAF1_Po3
   no shutdown
   switchport
...
interface Port-Channel4
   description server01_PortChannel4
   no shutdown
   switchport
...
| Loopback100 | Tenant_A_VRF1_VTEP_DIAGNOSTICS | Tenant_A_VRF1 | 10.255.1.4/32 |
...
| Vlan3009 |  Tenant_A_VRF1  |  10.255.251.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3010 |  Tenant_A_VRF2  |  10.255.251.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3019 |  Tenant_B_VRF1  |  10.255.251.1/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.255.251.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A_VRF1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 10.255.251.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A_VRF2 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 10.255.251.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_B_VRF1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A_VRF1 | 192.168.255.4:10 | 10:10 | - | - | learned | 110-111 |
| Tenant_A_VRF2 | 192.168.255.4:11 | 11:11 | - | - | learned | 120 |
| Tenant_B_VMOTION | 192.168.255.4:20260 | 20260:20260 | - | - | learned | 260 |
| Tenant_B_VRF1 | 192.168.255.4:20 | 20:20 | - | - | learned | 210 |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Tenant_A_VRF1 | 192.168.255.4:10 | connected |
| Tenant_A_VRF2 | 192.168.255.4:11 | connected |
| Tenant_B_VRF1 | 192.168.255.4:20 | connected |
...
| -------------- | --------------------- |
| Tenant_A_VRF1 | 10.255.1.4 |

## Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf Tenant_A_VRF1 address 10.255.1.4
```
