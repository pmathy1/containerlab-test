...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_AVD-LEAF1_Ethernet1 | routed | - | 172.31.255.0/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_AVD-LEAF2_Ethernet1 | routed | - | 172.31.255.4/31 | default | 1500 | false | - | - |
| Ethernet3 | P2P_LINK_TO_AVD-LEAF3_Ethernet1 | routed | - | 172.31.255.8/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_AVD-LEAF4_Ethernet1 | routed | - | 172.31.255.12/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_AVD-LEAF1_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_AVD-LEAF2_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description P2P_LINK_TO_AVD-LEAF3_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description P2P_LINK_TO_AVD-LEAF4_Ethernet1
   no shutdown
   mtu 1500
   no switchport
